    ...
    <ExternalLayout fixed={false} transparentTop={false}>
      <section>
        <Container>
          ...
          <br />
          <h5>Description of Website Services Offered</h5>
          <p>
            The Site is www.innexgo.com which has the following description: student attendance assurance and analytics through RFID technology.
          ...
          <p>
            ...
            Services and/or products. You, as the end user acknowledge, accept and agree that shall Innexgo not be held liable for any such updates, modifications, revisions, suspensions or discontinuance of any of our Services and/or products. Your continued
            use of the Services provided, aer such posting of any updates, changes, and/or modifications shall constitute acceptance of such updates, changes and/or modifications, and as such, frequent review of this Agreement and any and all applicable terms
            and policies should be made by you to ensure you are aware of all terms and policies currently in effect. Should you not agree to the updated, revised or modified terms, you must stop using the provided Services forthwith. Furthermore, the user
            understands, acknowledges and agrees that the Services offered shall be provided &quot;AS IS&quot; and as such Innexgo shall not assume any responsibility or obligation for the meliness, missed delivery, deleon and/or any failure to store user
            content, communication or personalization settings. Agreement and any and all applicable terms and policies should be made by you to ensure you are aware of all terms and policies currently in effect. Should you not agree to the updated, revised
            or modified terms, you must stop using the provided Services forthwith. Furthermore, the user understands, acknowledges and agrees that the Services offered shall be provided &quot;AS IS&quot; and as such Innexgo shall not assume any responsibility
            or obligation for the meliness, missed delivery, deleon and/or any failure to store user content, communication or personalization settings.
          </p>
          <br />
          <h5>Cautions for Global Use and Export and Import Compliance</h5>
          <p>Due to the global nature of the internet, through the use of our network you hereby agree to comply with all local rules relating to online conduct and that which is considered acceptable Content. Uploading, posting and/or transferring of software,
              technology and other technical data may be subject to the export and import laws of the United States and possibly other countries. Through the use of our network, you thus agree to comply with all applicable export and import laws, statutes and
        regulations, including, but not limited to, the Export Administration Regulations, as well as the sanctions control program of the United States. Furthermore, you state and pledge that you:</p>
          <ol type="a">
            <li>are not on the list of prohibited individuals which may be identified on any government export exclusion report nor a member of any other government which may be part of an export-prohibited country identified in applicable export and import laws
            and regulations;</li>
          ...
          <ol type="a">
            ...
            <li>Photos, audio, video and/or graphics submitted or made available for inclusion on the publicly accessible areas of Innexgo&apos;s sites, the license provided to permit to use, distribute, reproduce, modify, adapt, publicly perform and/or publicly
                display said Content on our network Services are for the sole purpose of providing and promoting the specific area in which this content was placed and/or made available for viewing. This license shall be available so long as you are a member
            of Innexgo&apos;s sites and shall terminate at such time when you elect to discontinue your membership.</li><br />
            <li>For any other content submitted or made available for inclusion on the publicly accessible areas of Innexgo&apos;s sites, the continuous, binding and completely sub-licensable license which is meant to permit to use, distribute, reproduce, modify,
            adapt, publish, translate, publicly perform and/or publicly display said content, whether in whole or in part, and the incorporation of any such Content into other works in any arrangement or medium current used or later developed.</li><br />
            <li>Those areas which may be deemed &quot;publicly accessible&quot; areas of Innexgo&apos;s sites are those such areas of our network properties which are meant to be available to the general public, and which would include message boards and groups
            that are openly available to users.</li>
          </ol>
          <br />
          <h5>Contributions to Company Website</h5>
          <p>Innexgo provides an area for our users to contribute feedback to our website. When you submit ideas, documents, suggestions and/or proposals (&quot;Contributions&quot;) to our site, you acknowledge and agree that:</p>
          <ol type="a">
            <li>your contributions do not contain any type of confidential or proprietary information;</li>
            <li>Innexgo shall not be liable or under any obligation to ensure or maintain confidentiality, expressed or implied, related to any Contributions;</li>
            <li>Innexgo shall be entitled to make use of and/or disclose any such Contributions in any such manner as they may see fit;</li>
            <li>the contributor&apos;s Contributions shall automatically become the sole property of Innexgo; and</li>
            <li>Innexgo is under no obligation to either compensate or provide any form or reimbursement in any manner or nature.
        </li>
          </ol>
          <br />
          <h5>Indemnity</h5>
        ...
        or indirectly, for any such damage or loss which may be a result of, caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods or Services made available on or through any such site or resource.</p>
          ...
          <p>You do hereby acknowledge and agree that Innexgo&apos;s Services and any essential software that may be used in connection with our Services (&quot;Software&quot;) shall contain proprietary and confidential material that is protected by applicable
        ...
        distribute, transmit, broadcast, publicly perform and/or created any plagiaristic works which are based on Innexgo Services (e.g. Content or Software), in whole or part.</p>
        ...
        our Services. Lastly, you also agree not to access or attempt to access our Services through any means other than through the interface, which is provided by Innexgo for use in accessing our Services.</p>
          <br />
          <h5>Warrenty Disclaimers</h5>
          <p>YOU HEREIN EXPRESSLY ACKNOWLEDGE AND AGREE THAT:</p>
          <ol type="a">
            <li>THE USE OF INNEXGO SERVICES AND SOFTWARE ARE AT THE SOLE RISK BY YOU. OUR SERVICES AND SOFTWARE SHALL BE PROVIDED ON AN &quot;AS IS&quot; AND/OR &quot;AS AVAILABLE&quot; BASIS. INNEXGO AND OUR SUBSIDIARIES, AFFILIATES, OFFICERS, EMPLOYEES, AGENTS,
            PARTNERS AND LICENSORS EXPRESSLY DISCLAIM ANY AND ALL WARRANTIES OF ANY KIND WHETHER EXPRESSED OR IMPLIED, INCLUDING, BUT NOT LIMITED TO ANY IMPLIED WARRANTIES OF TITLE, MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.</li><br />
            <li>INNEXGO AND OUR SUBSIDIARIES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS MAKE NO SUCH WARRANTIES THAT (i) INNEXGO SERVICES OR SOFTWARE WILL MEET YOUR REQUIREMENTS; (ii) INNEXGO SERVICES OR SOFTWARE SHALL BE UNINTERRUPTED, TIMELY, SECURE
                OR ERROR- FREE; (iii) THAT SUCH RESULTS WHICH MAY BE OBTAINED FROM THE USE OF THE INNEXGO SERVICES OR SOFTWARE WILL BE ACCURATE OR RELIABLE; (iv) QUALITY OF ANY PRODUCTS, SERVICES, ANY INFORMATION OR OTHER MATERIAL WHICH MAY BE PURCHASED OR
            OBTAINED BY YOU THROUGH OUR SERVICES OR SOFTWARE WILL MEET YOUR EXPECTATIONS; AND (v) THAT ANY SUCH ERRORS CONTAINED IN THE SOFTWARE SHALL BE CORRECTED.</li><br />
            <li>ANY INFORMATION OR MATERIAL DOWNLOADED OR OTHERWISE OBTAINED BY WAY OF INNEXGO SERVICES OR SOFTWARE SHALL BE ACCESSED BY YOUR SOLE DISCRETION AND SOLE RISK, AND AS SUCH YOU SHALL BE SOLELY RESPONSIBLE FOR AND HEREBY WAIVE ANY AND ALL CLAIMS AND
            CAUSES OF ACTION WITH RESPECT TO ANY DAMAGE TO YOUR COMPUTER AND/OR INTERNET ACCESS, DOWNLOADING AND/OR DISPLAYING, OR FOR ANY LOSS OF DATA THAT COULD RESULT FROM THE DOWNLOAD OF ANY SUCH INFORMATION OR MATERIAL.</li><br />
            <li>NO ADVICE AND/OR INFORMATION, DESPITE WHETHER WRITTEN OR ORAL, THAT MAY BE OBTAINED BY YOU FROM INNEXGO OR BY WAY OF OR FROM OUR SERVICES OR SOFTWARE SHALL CREATE ANY WARRANTY NOT EXPRESSLY STATED IN THE TOS.</li><br />
            <li>A SMALL PERCENTAGE OF SOME USERS MAY EXPERIENCE SOME DEGREE OF EPILEPTIC SEIZURE WHEN EXPOSED TO CERTAIN LIGHT PATTERNS OR BACKGROUNDS THAT MAY BE CONTAINED ON A COMPUTER SCREEN OR WHILE USING OUR SERVICES. CERTAIN CONDITIONS MAY INDUCE A PREVIOUSLY
                UNKNOWN CONDITION OR UNDETECTED EPILEPTIC SYMPTOM IN USERS WHO HAVE SHOWN NO HISTORY OF ANY PRIOR SEIZURE OR EPILEPSY. SHOULD YOU, ANYONE YOU KNOW OR ANYONE IN YOUR FAMILY HAVE AN EPILEPTIC CONDITION, PLEASE CONSULT A PHYSICIAN IF YOU EXPERIENCE
        ...
        the property of Innexgo. You herein agree not to display and/or use in any manner the Innexgo logo or marks without obtaining Innexgo&apos;s prior written consent.</p>
          ...
          <p>Innexgo will always respect the intellectual property of others, and we ask that all of our users do the same. With regards to appropriate circumstances and at its sole discretion, Innexgo may disable and/or terminate the accounts of any user who
              violates our TOS and/or infringes the rights of others. If you feel that your work has been duplicated in such a way that would constitute copyright infringement, or if you believe your intellectual property rights have been otherwise violated,
        you should provide us with the following information:</p>
          <ol type="a">
            <li>The electronic or physical signature of the individual that is authorized on behalf of the owner of the copyright or other intellectual property interest;</li>
            <li>A description of the copyrighted work or other intellectual property that you believe has been infringed upon;
        </li>
            ...
            <li>And, finally, a statement, made under penalty of perjury, that the aforementioned information in your notice is truthful and accurate, and that you are the copyright or intellectual property owner, representative or agent authorized to act on
        ...
        and conditions that may apply when you use or purchase certain other Services, affiliate Services, third-party content or third-party software.</p><br />
          <h5><i>Choice of Law and Forum</i></h5>
        ...
        in said state. You and Innexgo agree to submit to the jurisdiction of the courts as previously mentioned, and agree to waive any and all objections to the exercise of jurisdiction over the parties by such courts and to venue in such courts.</p><br />
          <h5><i>Waiver and Severability of Terms</i></h5>
        ...
        the parties nevertheless agree that the court should endeavor to give effect to the parties&apos; intentions as reflected in the provision, and the other provisions of the TOS remain in full force and effect.</p><br />
          <h5><i>Statue of Limitations</i></h5>
      ...
      <section id="cookie_policy">
        <Container>
          ...
          <p>
            Innexgo LLC uses cookies on www.innexgo.com and subdomains to www.innexgo.com. By using the Service, you consent to the use of cookies.
          ...
          <p>
            The Service uses Google Analytics to obtain and store user information and to identify unique visiters and sessions.
            Google Analytics provides statistics on how users interact with www.innexgo.com and marketing-related efforts by Innexgo LLC.
            This notice is in compliance with the Google Analytics Terms of Service. 
          </p>
          <br />
      ...
      <section id="privacy_policy">
        <Container>
          ...
          <p>
          This privacy policy ("policy") will help you understand how Innexgo LLC ("us", "we", "our") uses and protects the data you provide to us 
          when you visit and use www.innexgo.com ("website", "service"), effective January 20, 2020. 
          </p>
          <p>
          ...
          In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it 
          ...
          <p>
          Innexgo LLC is committed to securing your data and keeping it confidential. Innexgo LLC has done all in its 
          ...
          <br />
          <h5>CalOPPA (California Online Privacy Protection Act)</h5>
          <p>
            CalOPPA applies to any "commercial website owner [who] collects and maintains personally identifiable information 
            from a consumer residing in California. Innexgo LLC collects personally identifiable information restricted to full
            legal names and email addresses. 
          </p>
          <p>
            We honor Do Not Track (DNT) signals. When a DNT signal is present, Innexgo LLC does not track or plant cookies.
          </p>
          <p>
            Innexgo LLC uses Google Analytics to obtain and store user information and to identify unique visiters and sessions.
            See more information in Our Cookie Policy. 
          </p>
          <br />
          <h5>California "Online Eraser" Law for Minor Users</h5>
          <p>
            The California "Online Eraser" law allows California minors under 18 years of age to remove content or personal information
            upon request to Innexgo LLC after registration. While our services do not target California minors specifically, Innexgo LLC 
            indirectly gathers data of minors through attendance and exam creation upon use by administrators and teachers. We do not
            advertise our services to California minors. 
          </p>
          <p>
            You can request to correct or remove user data by emailing innexgo@gmail.com. Please incllude sufficient information to identify
            the data to be removed. 
          </p>
          <br />
          <h5>COPPA (Children's Online Privacy Protection Act)</h5>
          <p>
            COPPA protects the privacy of all children 13 years of age and under, and Innexgo LLC complies with federal and state statures regarding
            privacy protection. While Innexgo LLC targets administrators and teachers, and indirect users (students) of our services will be of 
            secondary schools, we acknowledge that children 13 years of age and under may use our service and have personal information collected. 
          </p>
          <p>
            Innexgo LLC will collect full legal names and email addresses upon registration. Furthermore, data will be gathered with navigation on our
            website through Google Analytics. (See Our Cookie Policy to learn more about how Innexgo LLC utilizes Google Analytics.) We do not publicize 
            or sell personal information. All personal information will be stored in databases owned and operated by Innexgo LLC. 
          </p>
          <p>
            COPPA requires direct notice to legal parents or guardians of children 13 years of age and under upon registration to services of Innexgo LLC.
            During registration, we will provide notice of an age registration to finalize registration. A prospective user 13 years of age and under will 
            be required to email Innexgo LLC affirmation of parental consent, to be sent to innexgo@gmail.com.
          </p>
          <p>
            Upon request, Innexgo LLC will provide legal parents or guardians descriptions of the personal information that may have been provided and collected
            during registration or through third parties. We allow legal parents or guardians to review, discontinue, and delete their child's personal information
            upon written request to innexgo@gmail.com. 
          </p>
          <br />
          <h5>Restricting the Collection of your Personal Data</h5>
          <p>
          At some point, you might wish to restrict the use and collection of your personal data. You can achieve this 
          by contact us via email. Innexgo will not lease, sell or distribute your personal information to any third parties, 
